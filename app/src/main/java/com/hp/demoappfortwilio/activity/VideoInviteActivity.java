...
import com.hp.demoappfortwilio.BuildConfig;
...
import com.hp.demoappfortwilio.service.RegistrationIntentService;
...
public class VideoInviteActivity extends AppCompatActivity {
    ...
    //first token abc
       public static String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..VahZWtEtmlWujzjqk5PUO8npXCHPinNzibEU77oiQkg";

    //Second token vinay
 //  public static String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..VzpYWpKzW4_J2X0oW6sV5vde8eoVDssIwMdnqWS3a5k";

    public static String token1 = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..3XDQqUn0Fs68MJ_TE9hEVTLkDeQNaHUthr0jkwWi4ak";

    private String accountId = "AC4ce4f0b57cdebbf21f04889e747beb6a";
    ...
    private void handleRegistration(Intent intent) {
        Log.e("hanleregister","handleregister");
  ...
  /*      Notification notification = new Notification(
                "Join " + "ranjitha" + " in room " + "testroom",
                "ranjitha" + " has invited you to join video room " + "testroom",
                invite.getMap(),
                NOTIFY_TAGS);*/

        Notification notification = new Notification(
                "Join " + "ranjitha" + " in room " + "room",
                "ranjitha" + " has invited you to join video room " + "room",
                invite.getMap(),
                NOTIFY_TAGS);
